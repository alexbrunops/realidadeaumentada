...
//	console.log("normals[" + i*3 + " =  (" + normals[i * 3 + 0] + " , " + normals[i * 3 + 1] + " , " + normals[i * 3 + 2] + ")");
...
//	console.log("vTangent[" + i*3 + " =  (" + vTangent[i * 3 + 0] + " , " + vTangent[i * 3 + 1] + " , " + vTangent[i * 3 + 2] + ")");
//	console.log("vBinormal[" + i*3 + " =  (" + vBinormal[i * 3 + 0] + " , " + vBinormal[i * 3 + 1] + " , " + vBinormal[i * 3 + 2] + ")");
}
...
//	console.log("hasNormals = " + hasNormals);
